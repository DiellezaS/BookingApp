...
# from accounts.models import Profile  # Importojme modelin Account nga aplikacioni accounts
...
#     photo = models.ImageField(upload_to='Booking\media\property_photos/', null=True, blank=True)
...
#         """Kontrollon nëse prona është e disponueshme për datat e kërkuara.""" # rrjeshti poshte e ndryshova per prove ne pending
#         return not Booking.objects.filter(property=self, status='pending') \
